                ...
                <c:forEach items="${salarys}" var="ss">
                    <div class="order">
                        <div class="order">
                            ...
                            <div class="order_title">${ss.payed == true?"已提现订单":"处理中订单"}</div>
                            ...
                            <c:if test="${ss.payed == false}">
                                <div class="cancel" style="border:#ff0023 1px solid; color:#ff0023;">处理中</div>
                            </c:if>
                            <c:if test="${ss.payed == true}">
                                <div class="cancel" style="border:#00ff1a 1px solid; color:#00ff1a;">已提现</div>
                            </c:if>
                            <div class="border_bottom"></div>
                        </div>
                    </div>
