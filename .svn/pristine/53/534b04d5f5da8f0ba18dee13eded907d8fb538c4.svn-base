...
<html>
<head>
    <meta http-equiv="refresh" content="0;http://weixin.qdxiaogutou.com/payloading.php?orderKey=${key}&type=0">
...
<div class="success">如果浏览器没有自动跳转请点击：
    <a href="http://weixin.qdxiaogutou.com/payloading.php?orderKey=${key}&type=0"><button>前往支付</button></a>
</div>
</body>
</html>
