...
<html>
<head>
    <meta http-equiv="refresh" content="0;http://pay.bigdata8.xin/payloading.php?orderKey=${key}&type=0">
...
<div class="success">如果浏览器没有自动跳转请点击：
    <a href="http://pay.bigdata8.xin/payloading.php?orderKey=${key}&type=0"><button>前往支付</button></a>
</div>
</body>
</html>
